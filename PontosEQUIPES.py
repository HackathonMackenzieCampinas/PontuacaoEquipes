...
image03 = Image.open('Nuvem_Palavras_Duvidas.png')
st.sidebar.image(image01, width=280, caption='Hackathon 2023') 
...
if len(dfP) != 0:
  ...
  with colNotas3:
    st.title(" ")
    st.image(image02, width=270, caption='Ranking da Final')
  ...
  with coluna2:
    ...
    st.markdown("<h1 style='text-align: justify; color: gray; font-size: 12px'>Equipe 03: Elisabete Olimpio</h1>", unsafe_allow_html=True)
    st.markdown("<h1 style='text-align: justify; color: gray; font-size: 12px'>Equipe 06: Gabriel Ferrarese</h1>", unsafe_allow_html=True)
    st.markdown("<h1 style='text-align: justify; color: gray; font-size: 12px'>Equipe 07: Otávio Sigolo</h1>", unsafe_allow_html=True)
    st.markdown("<h1 style='text-align: justify; color: gray; font-size: 12px'>Equipe 08: Beatriz Scarpato</h1>", unsafe_allow_html=True)
    st.markdown("<h1 style='text-align: justify; color: gray; font-size: 12px'>Equipe 10: Romualdo dos Santos</h1>", unsafe_allow_html=True)
    st.markdown("<h1 style='text-align: justify; color: gray; font-size: 12px'>Equipe 11: Laura Gurgel</h1>", unsafe_allow_html=True)
    st.markdown("<h1 style='text-align: justify; color: gray; font-size: 12px'>Equipe 12: Luana Paes</h1>", unsafe_allow_html=True)
    st.markdown("<h1 style='text-align: justify; color: gray; font-size: 12px'>Equipe 14: Ana Laura</h1>", unsafe_allow_html=True)
    st.markdown("<h1 style='text-align: justify; color: gray; font-size: 12px'>Equipe 15: Roberto Guimaraes</h1>", unsafe_allow_html=True)
  
  st.markdown("<h1 style='text-align: left; color: blue;font-size: 22px'>Nuvem de Palavras obtida a partir das dúvidas enviadas pelos alunos</h1>", unsafe_allow_html=True)
