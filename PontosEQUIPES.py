...
image03 = Image.open('Nuvem_de_Palavras_DUVIDAS.png')
...
if len(dfP) != 0:
  ...
  with coluna1:
    st.markdown("<h1 style='text-align: left; color: blue;font-size: 20px'>Participação dos Tutores (Alunos Mackenzie)</h1>", unsafe_allow_html=True)
